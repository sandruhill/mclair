...
Um dos principais desafios na área de dados é diminuir a distância entre o ambiente de experimentação teórico e o mundo real onde os modelos de produção operaram de fato. Ou seja, tirar do plano das ideias e colocar na prática o conhecimento adquirido pelo modelo M*achine Learning *(Aprendizado de Máquina).
