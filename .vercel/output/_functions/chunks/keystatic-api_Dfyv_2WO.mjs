    ...
    blog: collection({
      ...
      schema: {
        ...
        metaDescription: fields.text({
          ...
          description: "150–160 caracteres. Google exibe até ~160. Deixe em branco para usar o Subtítulo automaticamente.",
          multiline: true,
        ...
        aboutTopics: fields.array(
          fields.text({ label: "Tópico / Entidade" }),
          {
            ...
            description: "Entidades e temas abordados — melhora citações no ChatGPT, Perplexity e Google AI Overview",
            itemLabel: (props) => props.value
          }
        ),
        faqItems: fields.array(
          ...
          }),
          {
            ...
            description: "Perguntas e respostas — geram rich results no Google e aumentam citações em IA",
