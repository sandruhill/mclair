...
export default config({
  ...
  singletons: {
    homepage: singleton({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/',
      schema: {
    ...
    sobre: singleton({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/sobre',
      schema: {
        content: fields.object({
    ...
    clientes: singleton({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/clientes',
      schema: {
        content: fields.object({
    ...
    contato: singleton({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/contato',
      schema: {
        content: fields.object({
    ...
    mentorias: singleton({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/mentorias',
      schema: {
        content: fields.object({
  ...
  collections: {
    blog: collection({
      ...
      entryLayout: 'content',
      previewUrl: 'https://mclair.com.br/blog/{slug}',
      schema: {
        title: fields.slug({
          name: {
            label: 'Título',
    ...
    servicos: collection({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/servicos/{slug}',
      schema: {
    ...
    cases: collection({
      ...
      format: { data: 'json' },
      previewUrl: 'https://mclair.com.br/cases/{slug}',
      schema: {
